              ...
              for (var d = s[c], m = 0; m < l; m++) {
                ...
                if (p == d || d == "*") {
                  var L = r.node.edges[p],
                    ...
                    f = void 0;
                  p in r.output.edges
                    ? ((f = r.output.edges[p]), (f.final = f.final || w))
                    : ((f = new t.TokenSet()),
                      (f.final = w),
                      (r.output.edges[p] = f)),
          ...
          for (var l = 0; l < n.clauses.length; l++) {
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              for (var S = 0; S < w.length; S++)
                for (
                  var b = w[S], k = this.invertedIndex[b], _ = k._index, f = 0;
                  f < c.fields.length;
                  f++
                ) {
                  var y = c.fields[f],
          ...
          for (
            ...
            for (
              ...
              var f = m[w],
                ...
                _;
              i[f] === void 0
                ? ((b = t.idf(this.invertedIndex[f], this.documentCount)),
                  (i[f] = b))
                : (b = i[f]),
                (k =
                  (b * ((this._k1 + 1) * y)) /
    ...
    n.addEventListener(
      ...
      n.addEventListener("keydown", (i) => {
        i.key == "Enter"
          ? Ue(e, t)
          : i.key == "ArrowUp"
          ? (fe(e, n, -1), i.preventDefault())
          : i.key === "ArrowDown" && (fe(e, n, 1), i.preventDefault());
      }),
...
`),
  ...
  async function Ie() {
    ...
    i.classList.add("tsd-hierarchy-toggle"),
      (i.textContent = window.translations.hierarchy_expand),
      t.querySelector("h4 a")?.insertAdjacentElement("afterend", i),
      i.insertAdjacentText("beforebegin", ", "),
      i.addEventListener("click", () => {
        i.textContent === window.translations.hierarchy_expand
          ? (a.insertAdjacentElement("afterend", l),
            a.remove(),
            (i.textContent = window.translations.hierarchy_collapse))
          : (l.insertAdjacentElement("afterend", a),
            l.remove(),
            (i.textContent = window.translations.hierarchy_expand));
      });
    let s = +t.dataset.refl,
      o = await new Response(r).json(),
      a = t.querySelector("ul"),
      l = document.createElement("ul");
    l.classList.add("tsd-hierarchy"), Ze(l, o, s);
  }
  function Ze(t, e, n) {
  ...
  function Pe(t, e, n, r = new Set()) {
    ...
    if ((s.classList.add("tsd-hierarchy"), e === n)) {
